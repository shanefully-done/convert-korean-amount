...
var convertKoreanAmount = function (value, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.wordSpacing, wordSpacing = _c === void 0 ? true : _c, _d = _b.withWonSuffix, withWonSuffix = _d === void 0 ? true : _d, _e = _b.useComma, useComma = _e === void 0 ? true : _e;
    var result = UNIT_WORDS.reduce(function (prev, curr, i) {
        var v = Math.floor((value % Math.pow(SPLIT_UNIT, i + 1)) / Math.pow(SPLIT_UNIT, i));
        if (v === 0)
            return prev;
        return "".concat(useComma ? v.toLocaleString() : v).concat(curr) + (wordSpacing ? " " : "") + prev;
    }, "");
